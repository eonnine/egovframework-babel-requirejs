...
<!-- 공통 처리 부분 begin -->
<script src="/resources/script/requirejs-babel/babel-polyfill.js"></script>
<script src="/resources/script/require.js"></script>
<script src="/resources/script/requireConfig.js"></script>
<!-- 공통 처리 부분 end -->

<script>
require(['es6!index'], function(module){
	console.log(module);
});
</script>
</body>
